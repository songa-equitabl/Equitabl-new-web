    ...
    <Container className="container privacy-section privacy-page-container">
      ...
      <Row className="justify-content-center">
        <Col md="8">
          ...
          <p>Website refers to Equitabl, accessible from www.equitabl.io</p>
          ...
          <p>Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. You can learn more about cookies on <a className="link" href="https://www.termsfeed.com/blog/cookies/%23What_Are_Cookies/" target="_blank" rel="noopener noreferrer"> TermsFeed website</a> article.</p>
          ...
          <ul>
            <li>By email: contact@equitabl.io</li>
            </ul>
        </Col>
